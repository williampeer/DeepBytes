...
images = []
for i in range(10):
    cur_im = Tools.create_image_helper(training_patterns_associative[i][0])
...
im_2 = Image.new('1', (7*8*10, 7*8*2+4))
im_2.paste(aggregate_im, (1, 1))
im_2.paste(aggregate_im, (1, 7*8+2))
# im_2.show()

aggregate_im.save('aggregate_im', 'PNG')
im_2.save('im_both', 'PNG')
